...
///
/// Locales: 6
/// Strings: 2812 (468 per locale)
///
/// Built on 2025-12-05 at 13:08 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final _StringsOfflineEn offline = _StringsOfflineEn._(_root);
}
...
// Path: offline
class _StringsOfflineEn {
	_StringsOfflineEn._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get mode => 'Offline Mode';
	String get downloaded_content => 'Downloaded Content';
	String get downloaded_media => 'Downloaded Media';
	String get no_downloaded_content => 'No downloaded content available offline';
	String get no_downloads_yet => 'No downloads yet';
	String get download => 'Download';
	String get downloading => 'Downloading';
	String get completed => 'Downloaded';
	...
	String get manage_downloads => 'Manage Downloads';
	String get download_quality => 'Download Quality';
	String get wifi_only => 'Download on WiFi only';
...
class _StringsDe implements Translations {
	...
	@override late final _StringsOfflineDe offline = _StringsOfflineDe._(_root);
}
...
// Path: offline
class _StringsOfflineDe implements _StringsOfflineEn {
	_StringsOfflineDe._(this._root);

	@override final _StringsDe _root; // ignore: unused_field

	// Translations
	@override String get mode => 'Offline Modus';
	@override String get downloaded_content => 'Heruntergeladene Inhalte';
	@override String get downloaded_media => 'Heruntergeladene Medien';
	@override String get no_downloaded_content => 'Keine heruntergeladenen Inhalte offline verfügbar';
	@override String get no_downloads_yet => 'Noch keine Downloads';
	@override String get download => 'Herunterladen';
	@override String get downloading => 'Lädt herunter';
	@override String get completed => 'Heruntergeladen';
	@override String get failed => 'Download fehlgeschlagen';
	@override String get pending => 'Ausstehend';
	@override String get delete_download => 'Download löschen';
	@override String get download_progress => 'Download-Fortschritt';
	@override String get storage_used => 'Verwendeter Speicher';
	@override String get manage_downloads => 'Downloads verwalten';
	@override String get download_quality => 'Download-Qualität';
	@override String get wifi_only => 'Nur über WLAN herunterladen';
	@override String get auto_download => 'Automatischer Download';
	@override String get download_limit => 'Download-Limit';
}
...
class _StringsIt implements Translations {
	...
	@override late final _StringsOfflineIt offline = _StringsOfflineIt._(_root);
}
...
// Path: offline
class _StringsOfflineIt implements _StringsOfflineEn {
	_StringsOfflineIt._(this._root);

	@override final _StringsIt _root; // ignore: unused_field

	// Translations
	@override String get mode => 'Modalità Offline';
	@override String get downloaded_content => 'Contenuti Scaricati';
	@override String get downloaded_media => 'Media Scaricati';
	@override String get no_downloaded_content => 'Nessun contenuto scaricato disponibile offline';
	@override String get no_downloads_yet => 'Nessun download ancora';
	@override String get download => 'Scarica';
	@override String get downloading => 'Download in corso';
	@override String get completed => 'Scaricato';
	@override String get failed => 'Download fallito';
	@override String get pending => 'In attesa';
	@override String get delete_download => 'Elimina Download';
	@override String get download_progress => 'Progresso Download';
	@override String get storage_used => 'Memoria Utilizzata';
	@override String get manage_downloads => 'Gestisci Download';
	@override String get download_quality => 'Qualità Download';
	@override String get wifi_only => 'Scarica solo su WiFi';
	@override String get auto_download => 'Download Automatico';
	@override String get download_limit => 'Limite Download';
}
...
class _StringsNl implements Translations {
	...
	@override late final _StringsOfflineNl offline = _StringsOfflineNl._(_root);
}
...
// Path: offline
class _StringsOfflineNl implements _StringsOfflineEn {
	_StringsOfflineNl._(this._root);

	@override final _StringsNl _root; // ignore: unused_field

	// Translations
	@override String get mode => 'Offline Modus';
	@override String get downloaded_content => 'Gedownloade Inhoud';
	@override String get downloaded_media => 'Gedownloade Media';
	@override String get no_downloaded_content => 'Geen gedownloade inhoud beschikbaar offline';
	@override String get no_downloads_yet => 'Nog geen downloads';
	@override String get download => 'Downloaden';
	@override String get downloading => 'Aan het downloaden';
	@override String get completed => 'Gedownload';
	@override String get failed => 'Download mislukt';
	@override String get pending => 'In afwachting';
	@override String get delete_download => 'Download verwijderen';
	@override String get download_progress => 'Download Voortgang';
	@override String get storage_used => 'Gebruikte Opslag';
	@override String get manage_downloads => 'Beheer Downloads';
	@override String get download_quality => 'Download Kwaliteit';
	@override String get wifi_only => 'Alleen downloaden via WiFi';
	@override String get auto_download => 'Automatische Download';
	@override String get download_limit => 'Download Limiet';
}
...
class _StringsSv implements Translations {
	...
	@override late final _StringsOfflineSv offline = _StringsOfflineSv._(_root);
}
...
class _StringsCollectionsSv implements _StringsCollectionsEn {
	...
	@override String get removeFromCollectionFailed => 'Kunde inte ta bort från samling';
	@override String removeFromCollectionError({required Object error}) => 'Fel vid borttagning från samling: ${error}';
}

// Path: offline
class _StringsOfflineSv implements _StringsOfflineEn {
	_StringsOfflineSv._(this._root);

	@override final _StringsSv _root; // ignore: unused_field

	// Translations
	@override String get mode => 'Offline Läge';
	@override String get downloaded_content => 'Nedladdat Innehåll';
	@override String get downloaded_media => 'Nedladdade Media';
	@override String get no_downloaded_content => 'Inget nedladdat innehåll tillgängligt offline';
	@override String get no_downloads_yet => 'Inga nedladdningar ännu';
	@override String get download => 'Ladda ner';
	@override String get downloading => 'Laddar ner';
	@override String get completed => 'Nedladdat';
	@override String get failed => 'Nedladdning misslyckades';
	@override String get pending => 'Väntar';
	@override String get delete_download => 'Radera Nedladdning';
	@override String get download_progress => 'Nedladdningsförlopp';
	@override String get storage_used => 'Använt Lagringsutrymme';
	@override String get manage_downloads => 'Hantera Nedladdningar';
	@override String get download_quality => 'Nedladdningskvalitet';
	@override String get wifi_only => 'Ladda endast ner via WiFi';
	@override String get auto_download => 'Automatisk Nedladdning';
	@override String get download_limit => 'Nedladdningsgräns';
}
...
class _StringsZh implements Translations {
	...
	@override late final _StringsOfflineZh offline = _StringsOfflineZh._(_root);
}
...
class _StringsCollectionsZh implements _StringsCollectionsEn {
	...
	@override String removeFromCollectionError({required Object error}) => '从收藏中移除时出错：${error}';
}

// Path: offline
class _StringsOfflineZh implements _StringsOfflineEn {
	_StringsOfflineZh._(this._root);

	@override final _StringsZh _root; // ignore: unused_field

	// Translations
	@override String get mode => '离线模式';
	@override String get downloaded_content => '已下载内容';
	@override String get downloaded_media => '已下载媒体';
	@override String get no_downloaded_content => '没有可离线使用的已下载内容';
	@override String get no_downloads_yet => '暂无下载';
	@override String get download => '下载';
	@override String get downloading => '下载中';
	@override String get completed => '已下载';
	@override String get failed => '下载失败';
	@override String get pending => '等待中';
	@override String get delete_download => '删除下载';
	@override String get download_progress => '下载进度';
	@override String get storage_used => '已使用存储';
	@override String get manage_downloads => '管理下载';
	@override String get download_quality => '下载质量';
	@override String get wifi_only => '仅在WiFi下下载';
	@override String get auto_download => '自动下载';
	@override String get download_limit => '下载限制';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'offline.downloaded_content': return 'Downloaded Content';
			case 'offline.downloaded_media': return 'Downloaded Media';
			case 'offline.no_downloaded_content': return 'No downloaded content available offline';
			case 'offline.no_downloads_yet': return 'No downloads yet';
			case 'offline.download': return 'Download';
			case 'offline.downloading': return 'Downloading';
			case 'offline.completed': return 'Downloaded';
			case 'offline.failed': return 'Download Failed';
			case 'offline.pending': return 'Pending';
			case 'offline.delete_download': return 'Delete Download';
			case 'offline.download_progress': return 'Download Progress';
			case 'offline.storage_used': return 'Storage Used';
			case 'offline.manage_downloads': return 'Manage Downloads';
			case 'offline.download_quality': return 'Download Quality';
			case 'offline.wifi_only': return 'Download on WiFi only';
			case 'offline.auto_download': return 'Auto Download';
			case 'offline.download_limit': return 'Download Limit';
			default: return null;
		}
	}
}
...
extension on _StringsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'offline.mode': return 'Offline Modus';
			case 'offline.downloaded_content': return 'Heruntergeladene Inhalte';
			case 'offline.downloaded_media': return 'Heruntergeladene Medien';
			case 'offline.no_downloaded_content': return 'Keine heruntergeladenen Inhalte offline verfügbar';
			case 'offline.no_downloads_yet': return 'Noch keine Downloads';
			case 'offline.download': return 'Herunterladen';
			case 'offline.downloading': return 'Lädt herunter';
			case 'offline.completed': return 'Heruntergeladen';
			case 'offline.failed': return 'Download fehlgeschlagen';
			case 'offline.pending': return 'Ausstehend';
			case 'offline.delete_download': return 'Download löschen';
			case 'offline.download_progress': return 'Download-Fortschritt';
			case 'offline.storage_used': return 'Verwendeter Speicher';
			case 'offline.manage_downloads': return 'Downloads verwalten';
			case 'offline.download_quality': return 'Download-Qualität';
			case 'offline.wifi_only': return 'Nur über WLAN herunterladen';
			case 'offline.auto_download': return 'Automatischer Download';
			case 'offline.download_limit': return 'Download-Limit';
			default: return null;
		}
	}
...
extension on _StringsIt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'offline.mode': return 'Modalità Offline';
			case 'offline.downloaded_content': return 'Contenuti Scaricati';
			case 'offline.downloaded_media': return 'Media Scaricati';
			case 'offline.no_downloaded_content': return 'Nessun contenuto scaricato disponibile offline';
			case 'offline.no_downloads_yet': return 'Nessun download ancora';
			case 'offline.download': return 'Scarica';
			case 'offline.downloading': return 'Download in corso';
			case 'offline.completed': return 'Scaricato';
			case 'offline.failed': return 'Download fallito';
			case 'offline.pending': return 'In attesa';
			case 'offline.delete_download': return 'Elimina Download';
			case 'offline.download_progress': return 'Progresso Download';
			case 'offline.storage_used': return 'Memoria Utilizzata';
			case 'offline.manage_downloads': return 'Gestisci Download';
			case 'offline.download_quality': return 'Qualità Download';
			case 'offline.wifi_only': return 'Scarica solo su WiFi';
			case 'offline.auto_download': return 'Download Automatico';
			case 'offline.download_limit': return 'Limite Download';
			default: return null;
		}
	}
}
...
extension on _StringsNl {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'offline.mode': return 'Offline Modus';
			case 'offline.downloaded_content': return 'Gedownloade Inhoud';
			case 'offline.downloaded_media': return 'Gedownloade Media';
			case 'offline.no_downloaded_content': return 'Geen gedownloade inhoud beschikbaar offline';
			case 'offline.no_downloads_yet': return 'Nog geen downloads';
			case 'offline.download': return 'Downloaden';
			case 'offline.downloading': return 'Aan het downloaden';
			case 'offline.completed': return 'Gedownload';
			case 'offline.failed': return 'Download mislukt';
			case 'offline.pending': return 'In afwachting';
			case 'offline.delete_download': return 'Download verwijderen';
			case 'offline.download_progress': return 'Download Voortgang';
			case 'offline.storage_used': return 'Gebruikte Opslag';
			case 'offline.manage_downloads': return 'Beheer Downloads';
			case 'offline.download_quality': return 'Download Kwaliteit';
			case 'offline.wifi_only': return 'Alleen downloaden via WiFi';
			case 'offline.auto_download': return 'Automatische Download';
			case 'offline.download_limit': return 'Download Limiet';
			default: return null;
		}
	}
}
...
extension on _StringsSv {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'collections.removeFromCollectionFailed': return 'Kunde inte ta bort från samling';
			case 'collections.removeFromCollectionError': return ({required Object error}) => 'Fel vid borttagning från samling: ${error}';
			case 'offline.mode': return 'Offline Läge';
			case 'offline.downloaded_content': return 'Nedladdat Innehåll';
			case 'offline.downloaded_media': return 'Nedladdade Media';
			case 'offline.no_downloaded_content': return 'Inget nedladdat innehåll tillgängligt offline';
			case 'offline.no_downloads_yet': return 'Inga nedladdningar ännu';
			case 'offline.download': return 'Ladda ner';
			case 'offline.downloading': return 'Laddar ner';
			case 'offline.completed': return 'Nedladdat';
			case 'offline.failed': return 'Nedladdning misslyckades';
			case 'offline.pending': return 'Väntar';
			case 'offline.delete_download': return 'Radera Nedladdning';
			case 'offline.download_progress': return 'Nedladdningsförlopp';
			case 'offline.storage_used': return 'Använt Lagringsutrymme';
			case 'offline.manage_downloads': return 'Hantera Nedladdningar';
			case 'offline.download_quality': return 'Nedladdningskvalitet';
			case 'offline.wifi_only': return 'Ladda endast ner via WiFi';
			case 'offline.auto_download': return 'Automatisk Nedladdning';
			case 'offline.download_limit': return 'Nedladdningsgräns';
			default: return null;
		}
	}
}
...
extension on _StringsZh {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'collections.removeFromCollectionError': return ({required Object error}) => '从收藏中移除时出错：${error}';
			case 'offline.mode': return '离线模式';
			case 'offline.downloaded_content': return '已下载内容';
			case 'offline.downloaded_media': return '已下载媒体';
			case 'offline.no_downloaded_content': return '没有可离线使用的已下载内容';
			case 'offline.no_downloads_yet': return '暂无下载';
			case 'offline.download': return '下载';
			case 'offline.downloading': return '下载中';
			case 'offline.completed': return '已下载';
			case 'offline.failed': return '下载失败';
			case 'offline.pending': return '等待中';
			case 'offline.delete_download': return '删除下载';
			case 'offline.download_progress': return '下载进度';
			case 'offline.storage_used': return '已使用存储';
			case 'offline.manage_downloads': return '管理下载';
			case 'offline.download_quality': return '下载质量';
			case 'offline.wifi_only': return '仅在WiFi下下载';
			case 'offline.auto_download': return '自动下载';
			case 'offline.download_limit': return '下载限制';
			default: return null;
		}
	}
}
